...
var slider__circle = document.querySelector(".slider__circle")
var closeslider__circle = document.querySelector(".fa-xmark")
mail.onclick = function(){
    slider__circle.classList.add("active")
}
closeslider__circle.addEventListener('click', function(){
    slider__circle.classList.remove('active')
})
